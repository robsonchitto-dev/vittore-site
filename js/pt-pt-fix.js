(() => {
  ...
  const textReplacements = new Map([
    ...
    ['Especialistas em PDR atuam na sua estrutura para tratar danos de granizo, mossas e picos de volume, acelerar prazos e manter o padrão de qualidade.', 'Há mais de 18 anos reforçamos a capacidade das empresas com apoio especializado em PDR, reduzindo pintura desnecessária e tempo parado, com padrão e controlo.'],
    ['Especialistas em PDR atuam diretamente na sua estrutura para resolver danos de granizo e mossas, reduzir o tempo de reparação e manter elevados padrões de qualidade.', 'Há mais de 18 anos reforçamos a capacidade das empresas com apoio especializado em PDR, reduzindo pintura desnecessária e tempo parado, com padrão e controlo.'],
  ...
  const applyPortugalFixes = () => {
    ...
    setText('.hero .lead', 'Há mais de 18 anos reforçamos a capacidade das empresas com apoio especializado em PDR, reduzindo pintura desnecessária e tempo parado, com padrão e controlo.');
